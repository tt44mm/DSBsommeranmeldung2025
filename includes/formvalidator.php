...
class FormValidator 
{
    ...
    var $error_hash = array();
	var $custom_validators = array();
	
	function AddCustomValidator(&$customv)
	{
		// Sicherstellen, dass custom_validators ein Array ist
	...
	function addValidation($variable,$validator,$error)
	{
		...
		// Sicherstellen, dass validator_array ein Array ist
		if (!is_array($this->validator_array)) {
