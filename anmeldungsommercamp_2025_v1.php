...
se pueden ver los recorridos en el Campus de verano 2024 con car&aacute;cter orientativo. </em></p>
    ...
    <div class="legend">Hijo/a <span id="person_addresses_label"></span></div>-->
			...
			<div class="selectcurso" id="Kursbox" width="100%">
				<div class="subheader">Curso <span id="JUNG" style="display:none">Campus Correcaminos</span> <span id="ALT" style="display:none">Campus Coyote</span> - Precio final <span id="precio">0</span> </div>
